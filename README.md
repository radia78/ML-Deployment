...
## Results
The contrast is night and day. The Torchscript application is significantly slower than the ONNX Runtime application. On the left is the ONNX Runtime Framework running the LRSAPP instance segmentation model with 14-18 FPS and on the right is the Torchscript framework deploying the same model with 4-6 FPS.
<p align="center">
